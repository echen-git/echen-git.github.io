...
---
We built a SOTA computing library for evaluating aerosol sensitivities across the US. Our hyperdual-step method computes numerically exact first- and second-order sensitivities of species concentrations at 1/3 the cost.
